...
$(document).ready(function(){
	...
	$("#customEditor").html("var inputBuffer = audioProcessingEvent.inputBuffer;\nvar outputBuffer = audioProcessingEvent.outputBuffer;\nfor (var channel = 0; channel < outputBuffer.numberOfChannels; channel++)\n{\n\tvar inputData = inputBuffer.getChannelData(channel);\n\tvar outputData = outputBuffer.getChannelData(channel);\n\tfor (var sample = 0; sample < inputBuffer.length; sample++)\n\t{\n\t\toutputData[sample]=inputData[sample];\n\t}\n}");
	...
	$("#firLbl").click(function(){
		if($("#firCoef").is(":visible")){
			$("#firCoef").hide(500);
			$("#firLbl").html("Filtro FIR [mostrar]");
		}
		else{
			$("#firCoef").show(500);
			$("#customFilter").hide(500);
			$("#customLbl").html("Filtro Programável [mostrar]");
			$("#firLbl").html("Filtro FIR [esconder]");
		}
	});

	$("#customLbl").click(function(){
		if($("#customFilter").is(":visible")){
			$("#customFilter").hide(500);
			$("#customLbl").html("Filtro Programável [mostrar]");
		}
		else{
			...
			$("#firCoef").hide(500);
			$("#firLbl").html("Filtro FIR [mostrar]");
			$("#customLbl").html("Filtro Programável [esconder]");
		}
	});
