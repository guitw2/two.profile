...
$(document).ready(function(){
	...
	var filterCustom = audioCtx.createScriptProcessor(processorBufferSize);
	var bufferSecundario = [new Float32Array(processorBufferSize),new Float32Array(processorBufferSize)];
	//////////////////////////////////////////////////////////////////////////////////////////////////////
	// pq dois buffers dentro do buffer sedcundário? facilitaria apenas um append................
	
	...
	var nodeQueue = [audioCtx.destination, masterGain, analyser, source];
	...
	function resize_canvas(){
		...
		canvasImpulse.width = Math.round(container2.clientWidth*.97);
	...
	filterCustom.onaudioprocess = function(audioProcessingEvent) {	
				...
				case "file":
					if (!loaded) {
						...
						if($("#power").prop("checked")){
							source.connect(filterCustom);	
							filterCustom.connect(analyser);
